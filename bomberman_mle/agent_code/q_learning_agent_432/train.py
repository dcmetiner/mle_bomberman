...
CAUSING_OPPONENT_DEATH = "CAUSING_OPPONENT_DEATH"
CAUSING_OPPONENT_DEATH_MISSED = "CAUSING_OPPONENT_DEATH_MISSED"
...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    if action_id == 4 and self.feature_vector[4] == 5:
        events.append(CAUSING_OPPONENT_DEATH)
        self.logger.warn("You caused your opponent death. Good Job")
    elif self.feature_vector[4] == 5:
        events.append(CAUSING_OPPONENT_DEATH_MISSED)
        self.logger.warn("You might have caused your opponent death. BAD  Move")
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    self.logger.debug("***************************")
    self.logger.debug("")
    updated_q_val = (1 - ALPHA) * self.q_table[last_state_id, action_id] + ALPHA * (reward + GAMMA * 0)
    ...
    if last_game_state["round"] % 400 == 0:
        self.EPSILON *= 0.9
